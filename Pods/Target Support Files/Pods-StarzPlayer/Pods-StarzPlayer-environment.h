...
// Gigya-iOS-SDK
#define COCOAPODS_POD_AVAILABLE_Gigya_iOS_SDK
#define COCOAPODS_VERSION_MAJOR_Gigya_iOS_SDK 3
#define COCOAPODS_VERSION_MINOR_Gigya_iOS_SDK 3
#define COCOAPODS_VERSION_PATCH_Gigya_iOS_SDK 0
