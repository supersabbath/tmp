...
- (void)clearViews
{
    [[self viewWithTag:SCRUBBER_IMAGE_TAG] removeFromSuperviewWithConstraints];
    [[self viewWithTag:BUTTON_IMAGE_TAG] removeFromSuperviewWithConstraints];
    [[self viewWithTag:REMAINING_IMAGE_TAG] removeFromSuperviewWithConstraints];
    [[self viewWithTag:BUFFERED_IMAGE_TAG] removeFromSuperviewWithConstraints];
    [[self viewWithTag:ELAPSED_IMAGE_TAG] removeFromSuperviewWithConstraints];
    [[self viewWithTag:CURRENT_POSITION_TAG] removeFromSuperviewWithConstraints];
      constraintSetup = NO;
